		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Cruscotto Doc Finance",
									"targetURL": "#itorogelzcruscottodocfinance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"itorogelzcruscottodocfinance-display": {
								"semanticObject": "itorogelzcruscottodocfinance",
								"action": "display",
								"description": "Cruscotto Doc Finance",
								"title": "Cruscotto Doc Finance",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=it.orogel.zcruscottodocfinance",
									"url": sap.ui.require.toUrl("it/orogel/zcruscottodocfinance")
								}
							}
						}
					}
